...
//       Foothold(label: 'Play Calming Cafe Music', icon: Icon(Icons.music_note)),
...
//       Foothold(
//           label: 'Work on Personal Project', icon: Icon(Icons.star_rounded)),
...
//     footholds: [
//       Foothold(label: 'Turn off Lights', icon: Icon(Icons.cleaning_services)),
//       Foothold(label: 'Close the Windows', icon: Icon(Icons.cleaning_services)),
//       Foothold(label: 'Entertainment', icon: Icon(Icons.tv)),
